package com.crm.menu.order_manager.order.creation.input.good.choose;
...
import com.crm.menu.order_manager.order.creation.input.good.info.GoodInfoMenuModel;
...
public class ChooseGoodsMenuModel
{
    ...
    public void confirm()
    {
        ...
        Main.getInstance().replaceSceneContent("/com/crm/menu/order_manager/order/creation/input/order/order-input-menu.fxml");
    }
