...
/**
 * Created by Bohdan on 20.02.2017.
 */
public class SmsSample
{
    private static class SmsSender implements SmsEventListener
    {
        ...
        public SmsSender()
        {
            ...
            sms.setSender("1111"); // Set the sender number.
            sms.setMessage("Hello World!");
            sms.setRecipient("1111"); // The recipients phone number.
